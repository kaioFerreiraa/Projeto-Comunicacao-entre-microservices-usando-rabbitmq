package com.kaioferreira.pagamento.controller;
...
import com.kaioferreira.pagamento.service.VendaService;
...
public class VendaController {
	...
	public VendaVO create(@RequestBody VendaVO vendaVO) {
		VendaVO veVo = vendaService.create(vendaVO);
		
		veVo.add(linkTo(methodOn(VendaController.class).findById(veVo.getId())).withSelfRel());
